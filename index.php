...
$arrPostData['messages'][0]['baseUrl'] = "https://f.ptcdn.info/902/056/000/p6k34559wwESApUhdqC-o.jpg";
 $arrPostData['messages'][0]['baseSize']['hieght'] = 1040;
$arrPostData['messages'][0]['baseSize']['width'] = 1040;
$arrPostData['messages'][0]['action'][0]['type'] = "uri";
$arrPostData['messages'][0]['action'][0]['linkUri'] = "http://pth.ddns.net/queue.jpg";
$arrPostData['messages'][0]['action'][0]['area']['x'] = 0;
$arrPostData['messages'][0]['action'][0]['area']['y'] = 0;
$arrPostData['messages'][0]['action'][0]['area']['width'] = 500;
$arrPostData['messages'][0]['action'][0]['area']['heigth'] = 500;
